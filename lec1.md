# Class-5 Responsive Layout and CSS Grid
...
- Exploring Grid Properties to Create Layouts
- Flexbox vs Grid

---

title: What is Grid in CSS?
description: This section explains about Grid in CSS
duration: 300
card_type: cue_card
...
**[Ask the learners]**
What is a Grid?
Sometimes, when you have to create a very complex layout and you do not, you can use a Grid.
...
title: Grid Code
description: This section explains Grid by its HTML implementation.
duration: 3000
card_type: cue_card
...
What property is used to define the size of columns and rows in a CSS Grid?
...
title: Item level Grid
description: This section explains Item Level Grid by its HTML implementation.
duration: 1200
card_type: cue_card
...
Which CSS property is used to create a gap between columns and rows in a CSS Grid?
...
title: Grid Areas
description: This section explains what is Grid Areas
duration: 900
card_type: cue_card
...
Which CSS property is used to place an item in a specific cell within the CSS Grid?
...
title: Flexbox vs Grid (A Comparision)
description: This section explains what is Grid Areas
duration: 900
card_type: cue_card
...
**Flexbox**
One-Dimensional Layout: Flexbox is primarily used for laying out items in a single dimension, either a row or a column.
...
**Grid**
Two-Dimensional Layout: Grid allows for laying out items in both rows and columns simultaneously.
